...
\begin{beme-list}
	...
	Eine Reihe der Gestalt \myref{*} heißt \myemph{gewöhnliche Dirichletreihe}.
	
	\item Im Gegensatz zu Potenzreihen weisen Dirichletreihen ein anderes Konvergenzverhalten auf als das \myquote{auf Kreisscheiben}.
...
\begin{satz}
	Es sei $F(s) := \sum_{n=1}^\infty a(n) e^{-\lambda_n s}$ eine Dirichletreihe wie in \myref{oben} definiert.
