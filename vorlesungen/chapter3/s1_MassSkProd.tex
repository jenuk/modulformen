...
\begin{bewe}
	...
	\[
	\HH = \smashoperator{\bigcup_{M \in \Gamma(1)'}} \, M^{-1} \circ \closure{\F_1} = \smashoperator{\bigcup_{M \in \Gamma(1)'}} \, M \circ \closure{\F_2}
	\,.
	\]
	...
	= \smashoperator{\int\limits_{\HH \cap \closure{\F_1}}} f \opd w
	= \smashoperator{\int\limits_{\bigcup\limits_{M \in \Gamma(1)'} \!\!\!\!\!\! M \circ \closure{\F_2} \cap \closure{\F_1}}} f \opd w
	\,,
	\]
	...
	\begin{align*}
	\int\limits_{\closure{\F_1}} f \opd w
	&= \smashoperator[l]{\sum_{M \in \Gamma(1)'}} \, \smashoperator[r]{\int\limits_{M\circ \closure{\F_2} \cap \closure{\F_1}}} f \opd w
	= \smashoperator[l]{\sum_{M \in \Gamma(1)'}} \, \smashoperator[r]{\int\limits_{\closure{\F_2} \cap M^{-1} \circ \closure{\F_1}}} f(M \circ z) \opd w(M \circ z) \\
	&= \smashoperator[l]{\sum_{M \in \Gamma(1)'}} \, \smashoperator[r]{\int\limits_{\closure{\F_2} \cap M^{-1} \circ \closure{\F_1}}} f \opd w
	= \ldots = \int\limits_{\closure{\F_2}} f\opd w
	\,.
	\end{align*}
\end{bewe}
