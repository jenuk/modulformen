...
\end{bewe}
	...
	\begin{align*}
		\scalarprd{E_k}g
		&= \smashoperator[l]{\sum_{M \in \linksmodulo{\Gamma(1)_\infty'}{\Gamma(1)'}}} \int_{M \circ \closure \F} \conj{g(z)} y^{k-2} \opd x \opd y % Substituiere, Vertauschung wegen absoluter Konvergenz ok
